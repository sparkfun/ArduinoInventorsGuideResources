...
/********************************************************************************
   Arduino Inventor's Guide - Project 7 (Final / Complete)
   Desktop Greenhouse  
   
   Adding servo control and motor / fan control & isolating motor fan effect
   This fixes the 'jitter' and mis-readings
